...
redirects:
  ...
  - /docs/log-management/new-relic-logs/get-started/new-relic-logs-security
  - /docs/log-management/new-relic-logs/get-started/new-relic-logs-security-privacy
  - /docs/log-management/log-monitoring/get-started/new-relic-log-monitoring-security-privacy
  - /docs/log-management/log-management/get-started/new-relic-log-management-security-privacy
---
