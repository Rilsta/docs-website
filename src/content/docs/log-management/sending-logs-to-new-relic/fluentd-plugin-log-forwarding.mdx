...
redirects:
  ...
  - /docs/log-management/new-relic-logs/enable-logs/enable-new-relic-logs-fluentd
  - /docs/log-management/enable-logs/enable-logs/fluentd-plugin-logs
  - /docs/log-management/enable-log-monitoring-new-relic/enable-log-monitoring-new-relic/fluentd-plugin-log-forwarding
---
