...
redirects:
  - /docs/log-management/new-relic-logs/enable-logs/enable-new-relic-logs-firelens
  - /docs/log-management/new-relic-logs/enable-logs/enable-new-relic-logs-aws-firelens
  - /docs/log-management/enable-logs/enable-logs/aws-firelens-plugin-logs
  - /docs/log-management/enable-log-monitoring-new-relic/enable-log-monitoring-new-relic/aws-firelens-plugin-logs
  - /docs/log-management/enable-log-monitoring-new-relic/enable-log-monitoring-new-relic/aws-firelens-plugin-log-forwarding
---
