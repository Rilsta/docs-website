...
redirects:
  - /docs/log-management/enable-new-relic-logs/1-enable-logs/amazon-kinesis-data-firehose
  - /docs/log-management/enable-new-relic-logs/1-enable-logs/stream-logs-new-relic-using-amazon-kinesis-data-firehose
  - /docs/log-management/enable-new-relic-logs/1-enable-logs/stream-logs-new-relic-using-kinesis-data-firehose
  - /docs/log-management/enable-new-relic-logs/1-enable-logs/stream-logs-using-kinesis-data-firehose
  - /docs/log-management/enable-log-monitoring-new-relic/enable-log-monitoring-new-relic/stream-logs-using-kinesis-data-firehose
---
...
To forward logs to New Relic using Kinesis Data Firehose, you need a New Relic [Insert API key](/docs/insights/insights-data-sources/custom-data/send-custom-events-event-api#register).
...
5. Add the following endpoint under **HTTP endpoint URL**:
   ...
   ```
6. Paste your [Insert API key](https://docs.newrelic.com/docs/insights/insights-data-sources/custom-data/send-custom-events-event-api#register) in the **API key** field.
...
If no data appears after you enable log management, follow the [troubleshooting procedures](/docs/log-management/new-relic-logs/troubleshooting/no-data-appears-logs).
