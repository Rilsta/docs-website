...
redirects:
  - /docs/log-management/enable-new-relic-logs/1-enable-logs/forward-your-logs-using-new-relic-infrastructure-agent
  - /docs/log-management/enable-new-relic-logs/1-enable-logs/forward-your-logs-using-new-relic-infrastructure
  - /docs/log-management/enable-log-monitoring-new-relic/enable-log-monitoring-new-relic/forward-your-logs-using-infrastructure-agent
---
...
List of [custom attributes](/docs/insights/insights-data-sources/custom-data/insights-custom-data-requirements-limits), as key-value pairs, that can be used to send additional data with the logs which you can then [query](/docs/using-new-relic/data/understand-data/query-new-relic-data). For example, you can [enable built-in parsing rules](/docs/log-management/log-management/ui-data/new-relic-logs-parsing-built-rules-custom-parsing) by setting the `logtype` attribute.
...
...
 - name: tcp-simple-test 
    ...
    attributes: # You can add custom attributes to any source of logs
      ...
      <mark><a href="/docs/log-management/log-management/ui-data/new-relic-logs-parsing-built-rules-custom-parsing">logtype</a>: nginx # See https://docs.newrelic.com/docs/log-management/log-management/ui-data/new-relic-logs-parsing-built-rules-custom-parsing</mark>
...
If no data appears after you enable log management, follow [standard troubleshooting procedures](/docs/log-management/new-relic-logs/troubleshooting/no-data-appears-logs).
...
If no data appears after you enable log management, follow [standard log management troubleshooting procedures](/docs/log-management/new-relic-logs/troubleshooting/no-data-appears-logs).
...
The infrastructure agent can be configured to send its own logs to [New Relic](/docs/log-management/new-relic-logs/get-started/introduction-new-relic-logs). This can be useful for troubleshooting issues with log forwarding, the agent, or when contacting [support](https://support.newrelic.com/).
...
* [Configure your agent](/docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-apm-agents) to see contextual log data, such as [distributed tracing](/docs/understand-dependencies/distributed-tracing/get-started/introduction-distributed-tracing), stack traces, application logs, and more.
