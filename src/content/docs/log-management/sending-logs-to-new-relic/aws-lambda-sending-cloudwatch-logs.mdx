...
redirects:
  - /docs/log-management/new-relic-logs/enable-logs/enable-new-relic-logs-aws-lambda
  - /docs/log-management/new-relic-logs/enable-logs/enable-new-relic-logs-aws-cloudwatch
  - /docs/log-management/enable-logs/enable-logs/aws-cloudwatch-plugin-logs
  - /docs/log-management/enable-log-monitoring-new-relic/enable-log-monitoring-new-relic/aws-lambda-sending-cloudwatch-logs
---
