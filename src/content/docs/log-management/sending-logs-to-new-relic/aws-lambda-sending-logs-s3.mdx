...
redirects:
  - /docs/log-management/enable-new-relic-logs/1-enable-logs/aws-lambda-sending-logs-s3
  - /docs/log-management/enable-log-monitoring-new-relic/enable-log-monitoring-new-relic/aws-lambda-sending-logs-s3
---
...
<Callout variant="tip">
  Take advantage of New Relic's log parsing capabilities by specifying the log type as an environment variable for the Lambda function. For more information, see [Built-in parsing rulesets](/docs/log-management/new-relic-logs/ui-data/new-relic-logs-parsing-built-rules-custom-parsing#built-in-rules).
</Callout>
