...
redirects:
  - /docs/log-management/enable-new-relic-logs/1-enable-logs/vector-plugin-logs
  - /docs/log-management/enable-log-monitoring-new-relic/enable-log-monitoring-new-relic/vector-plugin-log-forwarding
---
...
* [New Relic license key](https://docs.newrelic.com/docs/accounts/install-new-relic/account-setup/license-key) (recommended) or [Insert API key](https://docs.newrelic.com/docs/insights/insights-data-sources/custom-data/introduction-event-api#register)
...
1. Choose one of the following options for adding a snippet to your `vector.conf` file (located in `/etc/vector` by default):

   <CollapserGroup>
     <Collapser
       id="nr-license"
       title="Configure with the New Relic license key (recommended)"
     >
       Replace <var>YOUR_LICENSE_KEY</var> with the [New Relic license key](https://docs.newrelic.com/docs/accounts/install-new-relic/account-setup/license-key):
     ...
     <Collapser
       id="insert-key"
       title="Configure with the New Relic Insert API key"
     >
       Replace <var>YOUR_INSERT_KEY</var> with the [Insert API key](https://docs.newrelic.com/docs/insights/insights-data-sources/custom-data/introduction-event-api#register):
       ...
       [sinks.new_relic_logs]
         ...
         type = "new_relic_logs" # must be: "new_relic_logs"
         inputs = ["mylog"] # example - value must be one or more source IDs
         insert_key = "<var>YOUR_INSERT_KEY</var>" 
         region = "us" # Enum, must be one of: "us" "eu" depending on your New Relic Logs account region
