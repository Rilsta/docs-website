...
redirects:
  ...
  - /node/35756
  - /docs/log-management/new-relic-logs/logs-api/introduction-new-relic-logs-api
  - /docs/log-management/new-relic-logs/log-api/introduction-log-api
  - /docs/log-management/log-monitoring/log-api/introduction-log-api
...
If our [logging solutions](/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs) don't meet your needs, you can use our Log API to send [log data](/docs/using-new-relic/data/understand-data/new-relic-data-types#log-data) directly to [New Relic's Log management](/docs/log-management/new-relic-logs/get-started/introduction-new-relic-logs) via an HTTP endpoint.
...
For where to find data sent via the Log API (including from integrations that use that API), see [Find log data](/docs/log-management/new-relic-logs/get-started/introduction-new-relic-logs#find-data).
