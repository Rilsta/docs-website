...
redirects:
  ...
  - /docs/log-management/new-relic-logs/enable-logs/enable-new-relic-logs-logstash
  - /docs/log-management/enable-logs/enable-logs/logstash-plugin-logs
  - /docs/log-management/enable-log-monitoring-new-relic/enable-log-monitoring-new-relic/logstash-plugin-log-forwarding
---
