...
tags:
  - Logs
redirects:
  - /docs/log-management/logs-landing-page
...
<LandingPageTileGrid>
  ...
  >
    ...
    * [Learn](/docs/log-management/new-relic-logs/get-started/introduction-new-relic-logs) about our log aggregation and management capabilities.
    * [Enable logging](/docs/log-management/enable-new-relic-logs/1-enable-logs) using our infrastructure agent, various AWS services, Fluentd, Fluent Bit, Kubernetes, etc.
  </LandingPageTile>
  ...
  >
    ...
    * Query, filter, alert, and use log details to uncover root causes with the [New Relic One UI](/docs/log-management/new-relic-logs/ui-data).
    * Send log data directly via HTTP endpoint with our [Log API](/docs/log-management/new-relic-logs/log-api/introduction-log-api).
  </LandingPageTile>
  ...
  >
    ...
    * Analyze [contextual logging data](/docs/log-management/enable-logs/configure-logs-context/configure-logs-context-apm-agents) from other components in your ecosystem to improve app development, performance, and uptime.
  </LandingPageTile>
</LandingPageTileGrid>

<ButtonLink
  role="button"
  to="/docs/log-management/table-of-contents"
  variant="primary"
>
