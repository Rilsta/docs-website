...
redirects:
  - /docs/log-management/new-relic-logs/ui-data/customizing-log-data
  - /docs/log-management/new-relic-logs/ui-data/customize-logs-using-parsing
  - /docs/log-management/new-relic-logs/ui-data/new-relic-logs-parsing-built-rules-custom-parsing
  - /docs/log-management/log-management/ui-data/new-relic-logs-parsing-built-rules-custom-parsing
  - /docs/log-management/log-management/ui-data/logs-parsing-built-rules-custom-parsing
---
...
The following `logtype` attribute values map to a standard parsing rulesets. See [Built-in parsing rules](/docs/log-management/log-management/ui-data/built-log-parsing-rulesets) to learn what fields are parsed for each rules.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        [`alb`](/docs/log-management/log-management/ui-data/built-log-parsing-rulesets#application-load-balancer)
      </td>
    ...
    <tr>
      <td>
        [`apache`](/docs/log-management/log-management/ui-data/built-log-parsing-rulesets#apache)
      </td>
    ...
    <tr>
      <td>
        [`cloudfront-web`](/docs/log-management/log-management/ui-data/built-log-parsing-rulesets#cloudfront)
      </td>
    ...
    <tr>
      <td>
        [`elb`](/docs/log-management/log-management/ui-data/built-log-parsing-rulesets#elastic-load-balancer)
      </td>
    ...
    <tr>
      <td>
        [`monit`](/docs/log-management/log-management/ui-data/built-log-parsing-rulesets#monit)
      </td>
    ...
    <tr>
      <td>
        [`mysql-error`](https://docs.newrelic.com/docs/log-management/log-management/ui-data/built-log-parsing-rulesets#mysql-error)
      </td>
    ...
    <tr>
      <td>
        [`nginx`](/docs/log-management/log-management/ui-data/built-log-parsing-rulesets#nginx)
      </td>
    ...
    <tr>
      <td>
        [`nginx-error`](/docs/log-management/log-management/ui-data/built-log-parsing-rulesets#nginx-error)
      </td>
    ...
    <tr>
      <td>
        [`route-53`](/docs/log-management/log-management/ui-data/built-log-parsing-rulesets#route-53)
      </td>
    ...
    <tr>
      <td>
        [`syslog-rfc5424`](/docs/log-management/log-management/ui-data/built-log-parsing-rulesets#syslog-rfc5424)
      </td>
...
Here are some examples of how to add `logtype` to logs sent by some of our [supported shipping methods](/docs/log-management/enable-new-relic-logs).
...
<CollapserGroup>
  ...
  >
    Add `logtype` as an [`attribute`](/docs/log-management/enable-log-management-new-relic/enable-log-monitoring-new-relic/forward-your-logs-using-infrastructure-agent#attributes). You must set the logtype for each named source.
  ...
  >
    You can add attributes to the JSON request sent to New Relic. In this example we add a `logtype` attribute of value `nginx` to trigger the built-in NGINX parsing rule. Learn more about using the [Logs API](https://docs.newrelic.com/docs/log-management/new-relic-logs/log-api/introduction-log-api).
