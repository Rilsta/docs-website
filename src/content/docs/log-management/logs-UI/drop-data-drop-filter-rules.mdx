...
redirects:
  - /docs/log-management/new-relic-logs/ui-data/dropping-data
  - /docs/log-management/new-relic-logs/ui-data/drop-data-drop-filter-rules
  - /docs/log-management/log-monitoring/ui-data/drop-data-drop-filter-rules
---
...
To create a new drop filter rule, you can use new or existing [log queries](/docs/log-management/new-relic-logs/ui-data/query-syntax-logs).
