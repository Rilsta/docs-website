...
redirects:
  ...
  - /docs/log-management/new-relic-logs/ui-data/explore-your-data-new-relic-logs-ui
  - /docs/log-management/log-management/ui-data/explore-your-data-new-relics-log-analytics
  - /docs/log-management/log-management/ui-data/explore-your-data-log-analytics
  - /docs/log-management/log-management/ui-data/explore-logs-data
---
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Logs**: Use the left nav in the Logs UI as an easy workflow through all logs, patterns, live-tail logging, and queries. Get more details about specific logs and their attributes from the center nav.
</figcaption>

To explore your logging data, follow this basic workflow.

1. If you have not [customized your New Relic One navigation bar](https://docs.newrelic.com/docs/new-relic-one/use-new-relic-one/ui-data/basic-ui-features/#custom-navigation), go to **[one.newrelic.com](https://one.newrelic.com)**, click **Browse data** and select **Logs**.
2. **Look for patterns:**

   * To spot suspicious spikes or drops in log messages, click the [log patterns](/docs/log-management/log-management/ui-data/find-unusual-logs-log-patterns-beta) icon on the left nav.
...
3. **Narrow your focus:**
   ...
   * To make your log messages easier to query and understand, use our [built-in parsing rules](/docs/log-management/log-management/ui-data/built-log-parsing-rulesets/), or [create your own parsing rules](/docs/log-management/log-management/ui-data/parsing/) for attributes that match a particular value.
   * To manage the amount of log data collected and to store fewer logs, create [drop filter rules](/docs/log-management/log-management/ui-data/drop-data-drop-filter-rules/) that avoid collecting data you don't need.
4. **Examine log details:**
   ...
   * To help troubleshoot problems related to a specific value in the log details, click the [**Show surrounding logs** <Icon name="fe-eye"/> icon](/docs/log-management/log-management/troubleshooting/find-issues-cause-or-impact-surrounding-logs) for the attribute's details.
...
5. **Search:**
   ...
   For more information, see the [Logs query syntax documentation](https://docs.newrelic.com/docs/log-management/log-management/ui-data/query-syntax-logs/).

<Callout variant="tip">
  To organize data within an account and to optimize query performance, create [data partition rules](https://docs.newrelic.com/docs/log-management/log-management/ui-data/data-partitions/).
</Callout>
...
6. **Get related logs:**
   ...
   * To immediately see how your system responds to deployments or other app changes, enable [live-tail logging](/docs/log-management/log-management/troubleshooting/view-log-messages-real-time-live-tail).
   * To view all the logs for a specific value, review the attributes list in the selected log's **Log details**.
   * To help identify an issue's root cause before it occurred or its impact after an event, click the [**Show surrounding logs** <Icon name="fe-eye"/> icon](/docs/log-management/log-management/troubleshooting/find-issues-cause-or-impact-surrounding-logs).
...
<CollapserGroup>
  ...
  >
    ...
    2. Search for results you want to plot; for example, `service_name:"checkout service" "process failed"`.
       ...
       Select a saved view.
    3. Click the **dashboard** icon, then fill out the details to add to an existing or new dashboard.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        From your app in APM [(logs in context)](https://docs.newrelic.com/docs/enable-logs-context-logs)
      </td>
    ...
    <tr>
      <td>
        From an error trace in APM [(logs in context)](https://docs.newrelic.com/docs/enable-logs-context-logs)
      </td>
