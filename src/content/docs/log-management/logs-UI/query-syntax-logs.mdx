...
redirects:
  ...
  - /docs/log-management/new-relic-logs/ui-data/query-syntax-logs
---

Use our [Logs UI](/docs/log-management/log-management/ui-data/use-logs-ui/) in New Relic One to quickly search through your log data in seconds. Each log lists available attributes in the `log_summary` column. To drill down into additional details, click any highlighted attribute.
