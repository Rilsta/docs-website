...
redirects:
  - /docs/log-management/new-relic-logs/troubleshooting/no-data-appears-logs
---

## Problem

After [enabling log management](/docs/log-management/new-relic-logs/enable-logs/enable-new-relic-logs), no data appears in your Logs UI after about five minutes.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Make sure you've installed a [compatible log forwarding plugin](https://docs.newrelic.com/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Run a query using the [`NrIntegrationErrors` NRQL event](/attribute-dictionary/?event=NrIntegrationError) to see if any errors are related to logging. For example, look for messages like:
