...
redirects:
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-php
  - /docs/log-management/enable-logs/logs-context-php/configure-logs-context-php
  - /docs/log-management/enable-log-monitoring-new-relic/logs-context-php/configure-logs-context-php
---
...
* A compatible [log forwarding plugin](/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs) if not using the built in New Relic Monolog Handler
...
If you have configured your logging as described above, run your application locally, ensure one or more log records are created, and check the New Relic [Logs UI](/docs/log-management/new-relic-logs/ui-data/explore-your-data-new-relic-logs-ui). You can find them using a query like this:
