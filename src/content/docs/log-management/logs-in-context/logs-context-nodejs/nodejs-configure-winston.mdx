...
metaDescription: A description of the New Relic's logs in context configuration process for the Winston Node.js extension.
redirects:
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-winston
  - /docs/log-management/enable-logs/logs-context-node/nodejs-configure-winston
  - /docs/log-management/enable-log-monitoring-new-relic/logs-context-nodejs/nodejs-configure-winston
---
...
1. [Enable log monitoring](/docs/introduction-new-relic-logs) with a compatible [log forwarding plugin](/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs).
