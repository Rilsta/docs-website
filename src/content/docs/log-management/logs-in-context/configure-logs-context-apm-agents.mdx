...
redirects:
  ...
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-apm-logs-context-logs
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-apm-agents
  - /node/36951
  - /docs/log-management/enable-logs/configure-logs-context/configure-logs-context-apm-agents
  - /docs/log-management/enable-log-monitoring-new-relic/configure-logs-context/configure-logs-context-apm-agents
  - /docs/log-management/new-relic-logs/enable-logs-context
  - /docs/log-management/new-relic-logs/apm-integration
  - /docs/log-management/log-monitoring/apm-integration
  - /docs/log-management/log-management/apm-integration
  - /docs/log-management/new-relic-logs/enable-logs/2-configure-logs-context-apm-agents
  - /docs/log-management/log-monitoring/enable-logs/configure-logs-context-apm-agents
---
...
<Callout variant="tip">
  To use logs in context and log management, as well as the rest of our [observability platform](https://one.newrelic.com), join the New Relic family! [Sign up](https://newrelic.com/signup) to create your free account in only a few seconds. Then ingest up to 100GB of data for free each month. Forever.
</Callout>
...
* [New Relic logs management](/docs/introduction-new-relic-logs) enabled, with a compatible [log forwarding plugin](/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs) installed.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [.NET agent](/docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-net)
      </td>
    ...
    <tr>
      <td>
        [Node.js agent](/docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-nodejs)
      </td>
    ...
    <tr>
      <td>
        [PHP agent](/docs/log-management/enable-logs/logs-context-php/configure-logs-context-php)
      </td>
    ...
    <tr>
      <td>
        [Python agent](/docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-python)
      </td>
    ...
    <tr>
      <td>
        [Ruby agent](/docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-ruby)
      </td>
...
For information on creating your own logging extension, see [logs in context API calls](/docs/log-management/new-relic-logs/apm-integration/apm-agent-apis-manual-logs-context-instrumentation).
