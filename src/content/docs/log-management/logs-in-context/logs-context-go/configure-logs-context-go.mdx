...
redirects:
  ...
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-go
  - /docs/log-management/enable-logs/logs-context-go/configure-logs-context-go
  - /docs/log-management/enable-log-monitoring-new-relic/logs-context-go/configure-logs-context-go
---
...
1. [Enable log management](/docs/introduction-new-relic-logs) with a compatible [log forwarding plugin](https://docs.newrelic.com/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs).
...
Confirm that you have [log management](/docs/introduction-new-relic-logs) enabled, with a compatible [log forwarding plugin](https://docs.newrelic.com/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs) installed to send your application logs to New Relic.
