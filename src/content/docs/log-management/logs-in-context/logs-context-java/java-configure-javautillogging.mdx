...
redirects:
  ...
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-java-util-logging
  - /docs/log-management/enable-logs/logs-context-java/java-configure-java-util-logging
  - /docs/log-management/enable-logs/logs-context-java/configure-logs-context-java-util-logging
  - /docs/log-management/enable-log-monitoring-new-relic/logs-context-java/java-configure-javautillogging
---
...
1. Update your project's dependencies to include the java.util.logging extension as applicable:
   ...
   * To update with Maven, add the following to your `pom.xml` file:
     ...
     <Callout variant="tip">
       Can't edit these files? You can [add the jars directly to the application classpath](https://docs.newrelic.com/docs/log-management/enable-new-relic-logs/logs-context-java/java-adding-classpath).
     </Callout>
