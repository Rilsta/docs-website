...
redirects:
  ...
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-java
  - /docs/log-management/enable-logs/logs-context-java/configure-logs-context-java
  - /docs/log-management/enable-log-monitoring-new-relic/logs-context-java/configure-logs-context-java
---
...
* [Log management](/docs/introduction-new-relic-logs) enabled, with a compatible [log forwarding plugin](https://docs.newrelic.com/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs) installed
...
Use Spring or Spring Boot and not sure which extension you need? See our [Spring documentation](/docs/log-management/enable-new-relic-logs/logs-context-java/configure-logs-spring-spring-boot).
