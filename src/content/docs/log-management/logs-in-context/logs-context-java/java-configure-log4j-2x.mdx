...
redirects:
  ...
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-log4j-2x
  - /docs/log-management/enable-logs/logs-context-java/java-configure-log4j-2x
  - /docs/log-management/enable-log-monitoring-new-relic/logs-context-java/java-configure-log4j-2x
---
...
1. [Enable logs management](/docs/introduction-new-relic-logs) with a compatible [log forwarding plugin](/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs).
