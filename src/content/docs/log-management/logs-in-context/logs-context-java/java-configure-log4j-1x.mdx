...
redirects:
  ...
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-log4j-1x
  - /docs/log-management/enable-logs/logs-context-java/java-configure-log4j-1x
  - /docs/log-management/enable-log-monitoring-new-relic/logs-context-java/java-configure-log4j-1x
---
