...
redirects:
  ...
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-dropwizard
  - /docs/log-management/enable-logs/logs-context-java/java-configure-dropwizard
  - /docs/log-management/enable-logs/logs-context-java/configure-logs-context-dropwizard
  - /docs/log-management/enable-log-monitoring-new-relic/logs-context-java/java-configure-dropwizard
---
...
1. [Enable log monitoring](https://docs.newrelic.com/docs/introduction-new-relic-logs) with a compatible [log forwarding plugin](https://docs.newrelic.com/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs).
...
Confirm that you have [log monitoring](/docs/introduction-new-relic-logs) enabled, with a compatible [log forwarding plugin](/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs) installed to send your application logs to New Relic.
