...
redirects:
  ...
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-logback
  - /docs/log-management/enable-logs/logs-context-java/configure-logs-context-logback
  - /docs/log-management/enable-logs/configure-logs-context/java-configure-logback
  - /docs/log-management/enable-log-monitoring-new-relic/logs-context-java/java-configure-logback
---
