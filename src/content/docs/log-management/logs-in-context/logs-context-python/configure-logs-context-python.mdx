...
metaDescription: A description of the logs in context configuration process for the Python agent.
redirects:
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-python
  - /docs/log-management/enable-logs/logs-context-python/configure-logs-context-python
  - /docs/log-management/enable-log-monitoring-new-relic/logs-context-python/configure-logs-context-python
---
