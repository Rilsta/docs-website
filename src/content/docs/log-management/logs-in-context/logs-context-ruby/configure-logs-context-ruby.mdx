...
redirects:
  ...
  - /docs/log-management/new-relic-logs/enable-logs-context/enable-logs-context-ruby
  - /docs/log-management/enable-logs/logs-context-ruby/configure-logs-context-ruby
  - /docs/log-management/enable-log-monitoring-new-relic/logs-context-ruby/configure-logs-context-ruby
---
...
1. [Enable log management](/docs/introduction-new-relic-logs) with a compatible [log forwarding plugin](/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs).
...
Confirm that you have [log management](/docs/introduction-new-relic-logs) enabled, with a compatible [log forwarding plugin](/docs/log-management/enable-logs/enable-logs/enable-new-relic-logs#enable-logs) installed to send your application logs to New Relic.
...
If you have deployed this application to an environment with a [log forwarder](https://docs.newrelic.com/docs/log-management/new-relic-logs/enable-logs/enable-new-relic-logs), your application's logs will appear in the New Relic [Logs UI](/docs/log-management/new-relic-logs/ui-data/explore-your-data-new-relic-logs-ui) with metadata linking them to a trace and a span. You can find them using a query like this:

```
entity.name:"your_app_name" has:trace.id
```

If you see JSON logs in your application's output, but no logs returned by a query like the above, check your [log forwarder](/docs/log-management/new-relic-logs/enable-logs/enable-new-relic-logs).
...
* the application is using a [supported logging framework](/docs/log-management/new-relic-logs/enable-logs/enable-new-relic-logs).
