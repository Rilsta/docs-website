...
redirects:
  ...
  - /node/36956
  - /docs/log-management/new-relic-logs/get-started/introduction-new-relic-logs
  - /docs/log-management/log-monitoring/get-started/get-started-log-monitoring
  - /docs/log-management/enable-logs/new-relic-logs/introduction-new-relic-logs
  - /docs/log-management/enable-log-management-new-relic/new-relic-logs/introduction-log-monitoring
---
...
* Visualize your log data directly from the [Logs UI](https://docs.newrelic.com/docs/log-management/new-relic-logs/ui-data/explore-your-data-new-relic-logs-ui).
...
* Forward your logs [using our Infrastructure agent](https://docs.newrelic.com/docs/log-management/enable-new-relic-logs/1-enable-logs/forward-your-logs-using-new-relic-infrastructure-agent) or our [Kubernetes plugin](/docs/log-management/enable-logs/enable-logs/kubernetes-plugin-logs).
* Use our plugins for well-known log forwarders, like [Fluentd](/docs/log-management/enable-logs/enable-logs/fluentd-plugin-logs), [Fluent Bit](/docs/log-management/enable-logs/enable-logs/fluent-bit-plugin-logs), and [Logstash](/docs/log-management/enable-logs/enable-logs/logstash-plugin-logs).
* Stream or ship your logs from Amazon using [AWS Lambda](/docs/log-management/enable-new-relic-logs/1-enable-logs/aws-lambda-sending-logs-s3) or [Kinesis](/docs/log-management/enable-new-relic-logs/1-enable-logs/stream-logs-new-relic-using-kinesis-data-firehose).
